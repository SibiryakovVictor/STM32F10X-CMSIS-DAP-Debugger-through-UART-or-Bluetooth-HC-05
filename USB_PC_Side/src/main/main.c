...
static void MX_USB_UP_Pin_Init(void);

extern void HAL_UART2_TxCpltCallback(void);
...
/*USART3 init function - for transmit data to swd debugger device*/
static void MX_USART3_UART_Init(uint32_t baudrate)
{
...
static void MX_USB_UP_Pin_Init(void)
{
  ...
  GPIO_InitStruct.Pin = USB_UP;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USB_UP_PORT, &GPIO_InitStruct);
  USB_UP_PORT->ODR &= ~USB_UP; 
}
